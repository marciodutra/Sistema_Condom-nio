...
<!DOCTYPE html>
<html>
<title>iDwell - Cadastro de condomínio</title>
<meta charset="UTF-8">
  ...
  <div class="ppi-default-main" style="margin-left:300px;margin-top:43px;">
    ...
    <div class="div-form">
      ...
      <form action="insereCondominio.php" method="POST" enctype="multipart/form-data">
        ...
        <h5>Endereço</h5>
        <input class="input-form" type="text" id="endCond" name="endCond" placeholder="Endereço do condomínio">

         <h5>Complemento</h5>
        <input class="input-form" type="text" id="compCond" name="compCond" placeholder="Complemento">
