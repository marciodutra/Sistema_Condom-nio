  ...
  <div class="ppi-default-main" style="margin-left:300px;margin-top:43px;">
    ...
    <!-- White frame -->
      <div class="ppi-default-container ppi-default-ul ppi-default-card-4 ppi-default-white">
		...
		<?php
        $IdAlter=$_POST["altId"];
        $altNomeCond=$_POST["altNomeCond"];
        $altEndCond=$_POST["altEndCond"];
		$altCompCond=$_POST['altCompCond'];
		$altBairroCond=$_POST["altBairroCond"];
		$altNumCond=$_POST['altNumCond'];	
			require("conecta.inc.php");
			$ok = conecta_bd() or die ("Não é possível conectar-se ao servidor.");
			print("Alteração do condomínio realizada:<p>");
			print("$IdAlter <b>$altNomeCond</b> $altEndCond $altCompCond $altBairroCond $altNumCond<p>");
			mysqli_query($ok, "update condominios set nomeCondominio='$altNomeCond', endereco='$altEndCond', complemento='$altCompCond', bairro='$altBairroCond' where idCondominio='$IdAlter'") or die ("Não é possível alterar dados do condomínio!");
			print("Dados do condomínio alterados com sucesso!");
		?>
